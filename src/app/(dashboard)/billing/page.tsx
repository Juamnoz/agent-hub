  ...
  return (
    <div className="space-y-5 pb-4 lg:max-w-[720px] lg:mx-auto">
      ...
      <div className="space-y-2">
        <motion.h2 {...fadeUp(0.08)} className="text-[13px] font-medium text-muted-foreground px-0.5">
          Planes disponibles
        </motion.h2>
        <div className="space-y-2">
          {PLANS.map((plan, i) => {
              ...
              >
                ...
                <div className="px-4 pb-3 grid grid-cols-1 gap-1.5">
                  {planT.features.map((feature, fi) => (
                    <div key={fi} className="flex items-center gap-2 text-[13px] text-muted-foreground">
